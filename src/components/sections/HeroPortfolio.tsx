    ...
    <section id="top" className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-6xl flex-col justify-center px-6 pb-16 pt-32 md:px-10 md:pt-36">
        ...
        <motion.p
          ...
          className="mt-8 max-w-[38rem] text-pretty text-lg leading-[1.65] text-[color:var(--color-text)] md:text-xl"
        >
          {t("p.hero.lead")}
        </motion.p>
        <motion.p
        ...
        >
          ...
          <span className="mx-1 hidden h-6 w-px bg-[color:var(--color-border-strong)] sm:block" aria-hidden />
          <a
